...
/****** Object:  Database [IndignadoFDb_Int]    Script Date: 04/16/2012 19:12:11 ******/
IF  EXISTS (SELECT name FROM sys.databases WHERE name = N'IndignadoFDb_Int')
DROP DATABASE [IndignadoFDb_Int]
GO
...
/****** Object:  Database [IndignadoFDb_Int]    Script Date: 04/16/2012 19:12:11 ******/
CREATE DATABASE [IndignadoFDb_Int] ON  PRIMARY 
( NAME = N'IndignadoFDb_Int', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL10.SQLEXPRESS\MSSQL\DATA\IndignadoFDb_Int.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'IndignadoFDb_Int_log', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL10.SQLEXPRESS\MSSQL\DATA\IndignadoFDb_Int_log.ldf' , SIZE = 4096KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [IndignadoFDb_Int] SET COMPATIBILITY_LEVEL = 100
GO

IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [IndignadoFDb_Int].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO

ALTER DATABASE [IndignadoFDb_Int] SET ANSI_NULL_DEFAULT OFF 
GO

ALTER DATABASE [IndignadoFDb_Int] SET ANSI_NULLS OFF 
GO

ALTER DATABASE [IndignadoFDb_Int] SET ANSI_PADDING OFF 
GO

ALTER DATABASE [IndignadoFDb_Int] SET ANSI_WARNINGS OFF 
GO

ALTER DATABASE [IndignadoFDb_Int] SET ARITHABORT OFF 
GO

ALTER DATABASE [IndignadoFDb_Int] SET AUTO_CLOSE OFF 
GO

ALTER DATABASE [IndignadoFDb_Int] SET AUTO_CREATE_STATISTICS ON 
GO

ALTER DATABASE [IndignadoFDb_Int] SET AUTO_SHRINK OFF 
GO

ALTER DATABASE [IndignadoFDb_Int] SET AUTO_UPDATE_STATISTICS ON 
GO

ALTER DATABASE [IndignadoFDb_Int] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO

ALTER DATABASE [IndignadoFDb_Int] SET CURSOR_DEFAULT  GLOBAL 
GO

ALTER DATABASE [IndignadoFDb_Int] SET CONCAT_NULL_YIELDS_NULL OFF 
GO

ALTER DATABASE [IndignadoFDb_Int] SET NUMERIC_ROUNDABORT OFF 
GO

ALTER DATABASE [IndignadoFDb_Int] SET QUOTED_IDENTIFIER OFF 
GO

ALTER DATABASE [IndignadoFDb_Int] SET RECURSIVE_TRIGGERS OFF 
GO

ALTER DATABASE [IndignadoFDb_Int] SET  DISABLE_BROKER 
GO

ALTER DATABASE [IndignadoFDb_Int] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO

ALTER DATABASE [IndignadoFDb_Int] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO

ALTER DATABASE [IndignadoFDb_Int] SET TRUSTWORTHY OFF 
GO

ALTER DATABASE [IndignadoFDb_Int] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO

ALTER DATABASE [IndignadoFDb_Int] SET PARAMETERIZATION SIMPLE 
GO

ALTER DATABASE [IndignadoFDb_Int] SET READ_COMMITTED_SNAPSHOT OFF 
GO

ALTER DATABASE [IndignadoFDb_Int] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [IndignadoFDb_Int] SET  READ_WRITE 
GO

ALTER DATABASE [IndignadoFDb_Int] SET RECOVERY SIMPLE 
GO

ALTER DATABASE [IndignadoFDb_Int] SET  MULTI_USER 
GO

ALTER DATABASE [IndignadoFDb_Int] SET PAGE_VERIFY CHECKSUM  
GO

ALTER DATABASE [IndignadoFDb_Int] SET DB_CHAINING OFF 
GO

--Imagen
USE [IndignadoFDb_Int]
GO
