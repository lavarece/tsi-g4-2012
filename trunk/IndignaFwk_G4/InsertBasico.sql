...
/* grupos */
insert into Sitio (Nombre, Descripcion, Url, Coordenadas, FK_Id_Layout, FK_Id_Tematica) values ('No al abuso animal en circos y zoologicos', 'Todos vemos el maltrato a animales indefensos, a no quedarse callado! Sumate!', 'abuso_animal', '(-34.89043666790253, -56.17309534374999)', 1, 1); 
insert into Sitio (Nombre, Descripcion, Url, Coordenadas, FK_Id_Layout, FK_Id_Tematica) values ('Protección al oso panda', 'Somos un grupo sudamericano unido para protejer a los osos pandas. Se estima que quedan sólo de 2000 osos pandas. Sumate a nuestra causa! ', 'zonapanda', '(-34.89043666790253, -56.17309534374999)', 1, 2); 
insert into Sitio (Nombre, Descripcion, Url, Coordenadas, FK_Id_Layout, FK_Id_Tematica) values ('No a la contaminación lumínica', 'Nuestro fin es promover medidas para prevenir la contaminación luminica', 'no-a-la-contaminacion-luminica', '(-34.89043666790253, -56.17309534374999)', 1, 3);
insert into Sitio (Nombre, Descripcion, Url, Coordenadas, FK_Id_Layout, FK_Id_Tematica) values ('Contra el monopolio informático', 'Evitemos el monopolio de las empresa informaticas, ayudanos a promover medidas!', 'contra_monopolio_informatico', '(-34.89043666790253, -56.17309534374999)', 1, 4);
insert into Sitio (Nombre, Descripcion, Url, Coordenadas, FK_Id_Layout, FK_Id_Tematica) values ('Contra el abuso infantil', 'NO al abuso infantil!', 'noabuso', '-34.831841,-56.195068', 2, 1);
...
¡La tierra no se vende, la tierra se defiende!', 'noalamegamineria', '-34.831841,-56.195068', 2, 2);
insert into Sitio (Nombre, Descripcion, Url, Coordenadas, FK_Id_Layout, FK_Id_Tematica) values ('Igualdad de clase', 'Clases Sociales e Igualdad de las Personas, Igualdad de Deberes y de Derechos', 'todos_iguales', '(-34.89043666790253, -56.17309534374999)', 2, 3);
insert into Sitio (Nombre, Descripcion, Url, Coordenadas, FK_Id_Layout, FK_Id_Tematica) values ('No rompan internet. No al SOAP', 'SOPA (Stop Online Piracy Act) es un proyecto de ley introducido en la Cámara de Representantes de Estados Unidos el pasado 26 de octubre de 2011,
 con el objetivo de ampliar las capacidades de los propietarios de derechos intelectuales para supuestamente combatir el tráfico de contenidos en internet y productos protegidos por derechos de autor o por la propiedad intelectual.', 'no_sopa', '(-34.89043666790253, -56.17309534374999)', 2, 4);
insert into Sitio (Nombre, Descripcion, Url, Coordenadas, FK_Id_Layout, FK_Id_Tematica) values ('No a la piratería', 'Porque es un tema que nos afecta a todos, NO a la piratería', 'no_pirateria', '(-34.89043666790253, -56.17309534374999)', 3, 1);
insert into Sitio (Nombre, Descripcion, Url, Coordenadas, FK_Id_Layout, FK_Id_Tematica) values ('NO USO de agrotoxico', 'Porque las consecuencias de los agrotóxicos se transmiten a las futuras generaciones, no aceptemos alimentos envenenados con agrotoxicos', 'no_agrotoxico', '(-34.89043666790253, -56.17309534374999)', 3, 2);
insert into Sitio (Nombre, Descripcion, Url, Coordenadas, FK_Id_Layout, FK_Id_Tematica) values ('Discriminación de género', 'Si alguna vez sentiste discriminación, Unite! Todos contra la discriminación', 'no_discrimines', '(-34.89043666790253, -56.17309534374999)', 3, 3);
insert into Sitio (Nombre, Descripcion, Url, Coordenadas, FK_Id_Layout, FK_Id_Tematica) values ('No a la basura espacial', 'La basura espacial es un tema de preocupación que sin duda comenzará pronto a tomar importancia. No esperemos hasta ese día! Unite hoy y busquemos soluciones!', 'no_basura_espacial', '(-34.89043666790253, -56.17309534374999)', 3, 4);
