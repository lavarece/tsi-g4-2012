...
namespace IndignaFwk.Common.Util
{
    ...
    {
        private static const String STR_CONEXION_BD = "Data Source=JuanMa\SQLEXPRESS;Initial Catalog=IndignadoFDb;Persist Security Info=True;User ID=jmg216;Password=enano20";
